...
html_extra_path = ['_static', './docs/javadoc']
# VCS options: https://docs.readthedocs.io/en/latest/vcs.html#github
html_context = {
    "display_github": True, # Integrate GitHub
    "github_repo": "Governance-DOC", # Repo name
...
htmlhelp_basename = 'Governance-Doc'
...
latex_documents = [
  (master_doc, 'Governance-Doc.tex', u'WeBankBlockchain Gov Documentation',
...
texinfo_documents = [
  (master_doc, 'WeBankBlockchain Gov Doc', u'WeBankBlockchain Gov Documentation',
   author, 'blockchain-dev', 'documents of WeBankBlockchain Gov',
   'Miscellaneous'),
]
